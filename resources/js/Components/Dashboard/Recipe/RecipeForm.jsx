...
export default function RecipeForm({
    ...
    const form = useForm({
        ...
        ingredients: Array.isArray(defaultData?.ingredients)
            ? defaultData.ingredients
            : [],
        steps: Array.isArray(defaultData?.steps) ? defaultData.steps : [],
        nutritions: Array.isArray(defaultData?.nutritions)
            ? defaultData.nutritions
            : [],
        health_tags: Array.isArray(defaultData?.health_tags)
            ? defaultData.health_tags
            : [],
        allergy_tags: Array.isArray(defaultData?.allergy_tags)
            ? defaultData.allergy_tags
            : [],
        nutrition_tags: Array.isArray(defaultData?.nutrition_tags)
            ? defaultData.nutrition_tags
            : [],
        diet_tags: Array.isArray(defaultData?.diet_tags)
            ? defaultData.diet_tags
            : [],
    });
