        ...
        {ingredients.map((item, index) => (
          <div key={index} className="flex items-center gap-2">
            ...
            <input
              ...
              placeholder="0"
              value={item.jumlah}
              onChange={(e) => updateIngredient(index, 'jumlah', e.target.value)}
            ...
            <select
              value={item.takaran}
              onChange={(e) => updateIngredient(index, 'takaran', e.target.value)}
            ...
            <input
              ...
              value={item.nama}
              onChange={(e) => updateIngredient(index, 'nama', e.target.value)}
